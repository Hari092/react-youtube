...
//     if (isEditing) {
//       setUserName(first.current.value);
...
//   console.log(userName, lastName, nickName, phoneNumber, userAddress,data);
...
//           {isEditing ? "Save" : "Edit"}
//         </button>
//         <button className="text-white bg-black p-2 m-2" onClick={toggleSignOut}>
//           Logout
//         </button>
//       </div>
//     </div>
